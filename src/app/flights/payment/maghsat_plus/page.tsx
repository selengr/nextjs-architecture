...
const Maghsat_plus = () => {
  ...
  const total_amount = () => {
    ...
    booking.passenger.map(
      (item: any, index: number) => (amount += parseInt(item.payable_Fare))
    );
    return amount;
  };
    ...
    <div className="flex flex-col bg-ms-pay w-full">
      <div className="w-full bg-ms-violet pb-3 flex justify-around place-items-end rounded-b-3xl relativel min-h-[110px] h-28">
        <div className="w-full flex justify-center ">
          <ArrowBackIcon
            onClick={router.back}
            className="ml-1 absolute right-4 text-ms-white rotate-180"
          />
      ...
      <div className="p-4">
        ...
        >
          ...
          <span className="">{total_amount()} تومان </span>
        </div>
        ...
        <div className="w-[92%] mt-4 font-ms-bold text-ms-sm max-w-[549px] fixed bottom-12">
          ...
          <div>
            <UiButton
              ...
              className="hover:bg-[#07BEB8] text-ms-lg h-[50px] w-full border-none text-ms-white font-ms-medium bg-[#07BEB8] rounded-2xl"
            >
