...
export default function FormControlerBth({
  id,
  name,
  label,
  errors = false,
    ...
    <Stack spacing={1} className="w-full">
      ...
      <FormControl defaultValue="" className="w-full">
        {({ filled, focused, error }) => (
          <React.Fragment>
            <StyledBox className="flex flex-row bg-ms-white rounded-2xl relative">
              <StyledInput
                type="number"
                error={errors}
                id={id}
              ...
              <Button
                ...
                className="w-[25%] text-ms-lgbg-ms-btn-green-23 rounded-r-2xl rounded-l-none absolute -top-0"
              >
                بررسی
              </Button>
            </StyledBox>
