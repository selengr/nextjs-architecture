...
const MultiStep2_Characteristics = () => {
  ...
  const onSubmit = (data: any) => {
    ...
    router.push('?query=welfare-sevices');
  };
    ...
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="w-full">
        ...
        <FormControlFunctionChild
          ...
          name={'test'}
          id={'test'}
          label={'توصیف فضای اتاق'}
          placeholder="مانند:نور گیر رو به دریا فضای امن"
          istextarea={true}
        />
        ...
        <Stack spacing={2} m={2} mt={4} className="px-2 rounded-2xl">
          <Paper elevation={0} sx={{ borderRadius: '15px' }}>
            ...
            <Typography
              ...
              component="h5"
            >
              در صورت نداشتن پله و داشتن توالت فرنگی این بخش را می توانید .فعال
              کنید
            </Typography>
          </Paper>
        </Stack>
...
export default MultiStep2_Characteristics;
