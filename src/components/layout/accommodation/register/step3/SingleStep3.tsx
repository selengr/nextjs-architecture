...
const SingleStep3 = () => {
  ...
  const onSubmit = (data: any) => {
    ...
    router.push('?details=facilities');
  };
      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="w-full">
          <FormControlFunctionChild
            ...
            caption=" .درباره ویژگی ها چشم اندازها و هرآنچه که اقامت شما را منحصر به فرد میکند بنویسید."
            required={true}
          />
          <FormControlFunctionChild
            register={register}
