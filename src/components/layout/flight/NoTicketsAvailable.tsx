  ...
  return (
    <div className="w-full flex flex-col justify-center items-center mt-4">
      <Image
        ...
        className={'w-[50%] mb-2'}
      />
      <span className=" text-ms-thick-green text-ms-sm font-ms-medium pt-6">
        در تاریخ و مسیر مورد نظر پروازی موجود نیست !
      </span>
      <div className="bg-ms-yellow-14 rounded-2xl w-full p-4 my-8">
        ...
        <span className="text-ms-thick-green text-ms-xs font-ms-medium">
          در صورت خالی شدن ظرفیت یکی از پروازها به من اطلاع بده.
        </span>
      </div>
    </div>
  );
